        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="md:hidden p-2 rounded-lg transition-all duration-200 bg-gray-800 text-gray-300 hover:bg-gray-700"
            >
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden bg-gray-900 border-b border-gray-700 z-[9999]"
          >
            <div className="px-4 py-2 space-y-1">
              {navItems.map((item) => (
                <Link
                  ...
                  className="block px-3 py-2 text-gray-300 hover:text-cyan-400 transition-colors duration-200 font-medium text-sm"
                >
                  {item.name}
                </Link>
              ))}
