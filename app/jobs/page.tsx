  ...
  const jobs = [
    {
      ...
      company: 'TechCorp Telecom',
      location: 'San Francisco, CA',
      type: 'Full-time',
      experience: 'Senior',
      salary: '$120k - $160k',
      description: 'Lead development of next-generation telecom applications using React, Node.js, and cloud technologies.',
    ...
    },
    {
      ...
      salary: '$90k - $120k',
      description: 'Design and implement network infrastructure for large-scale telecom operations.',
      benefits: ['Health Insurance', 'Paid Time Off', 'Training Budget', 'Flexible Hours'],
      posted: '1 week ago',
    },
    {
      id: 3,
      title: 'DevOps Engineer',
      company: 'CloudTel Inc.',
      location: 'Seattle, WA',
      type: 'Full-time',
      experience: 'Senior',
      salary: '$130k - $170k',
      description: 'Manage CI/CD pipelines and cloud infrastructure for telecom services.',
    ...
    },
    {
      ...
      benefits: ['Health Insurance', 'Paid Time Off', 'Stock Options', 'Gym Membership'],
      posted: '5 days ago',
    },
    {
      id: 5,
      title: 'Data Scientist',
      company: 'DataTel Analytics',
      location: 'Boston, MA',
      type: 'Full-time',
      experience: 'Senior',
      salary: '$140k - $180k',
      description: 'Analyze large datasets to improve telecom network performance and customer experience.',
    ...
    },
    {
      ...
      company: 'DesignTel Studio',
      location: 'Los Angeles, CA',
      type: 'Full-time',
      experience: 'Mid-level',
      salary: '$80k - $110k',
      description: 'Create intuitive user interfaces for telecom applications and platforms.',
      benefits: ['Health Insurance', 'Paid Time Off', 'Creative Budget', 'Flexible Hours'],
      posted: '4 days ago',
    },
  ];
  ...
  return (
    <main className="pt-16">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/images/corporate-large.webp')",
        }}
      >
        {/* Floating Elements */}
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      {[
        ...
        >
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4 z-10 relative">
            {item.title}
          </h3>
